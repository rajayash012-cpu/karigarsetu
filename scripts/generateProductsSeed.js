...
// 108 authentic Indian handcrafted products
const RAW_PRODUCTS = [
  // 1. BIHAR - Savita Devi (artisan-1)
  {
    ...
    transportCost: 80,
    otherCost: 50,
    markup: 780, // price = 2370 + 780 = 3150
    stock: 25,
  ...
  },
  {
    ...
    transportCost: 150,
    otherCost: 120,
    markup: 1750, // totalCost = 6750, price = 8500
    stock: 12,
  ...
  },
  {
    ...
    transportCost: 30,
    otherCost: 15,
    markup: 95, // totalCost = 355, price = 450
    stock: 80,
  ...
  // 2. BIHAR - Sanjay Prasad (artisan-2)
  {
    ...
    transportCost: 50,
    otherCost: 30,
    markup: 305, // totalCost = 945, price = 1250
    stock: 35,
  ...
  },
  {
    ...
    transportCost: 30,
    otherCost: 15,
    markup: 84, // totalCost = 396, price = 480
    stock: 55,
  ...
  // 3. BIHAR - Geeta Kumari (artisan-3)
  {
    ...
    transportCost: 50,
    otherCost: 30,
    markup: 315, // totalCost = 1135, price = 1450
    stock: 45,
  ...
  },
  {
    ...
    transportCost: 80,
    otherCost: 50,
    markup: 710, // totalCost = 2490, price = 3200
    stock: 20,
  ...
  // 4. JHARKHAND - Meena Kumari (artisan-4)
  {
    ...
    transportCost: 60,
    otherCost: 40,
    markup: 540, // totalCost = 1910, price = 2450
    stock: 40,
  ...
  },
  {
    ...
    transportCost: 180,
    otherCost: 100,
    markup: 1480, // totalCost = 5320, price = 6800
    stock: 15,
  ...
  },
  {
    ...
    transportCost: 15,
    otherCost: 10,
    markup: 84, // totalCost = 196, price = 280
    stock: 120,
  ...
  // 5. JHARKHAND - Budhram Soren (artisan-5)
  {
    ...
    transportCost: 90,
    otherCost: 50,
    markup: 1090, // totalCost = 2710, price = 3800
    stock: 22,
  ...
  },
  {
    ...
    transportCost: 60,
    otherCost: 40,
    markup: 480, // totalCost = 1370, price = 1850
    stock: 30,
...
// Helper to assemble full products list
console.log("Raw initial products count:", RAW_PRODUCTS.length);
