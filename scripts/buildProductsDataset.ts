...
// Map each artisan by ID to their products
const ARTISAN_PRODUCTS: Record<string, ProductSpec[]> = {
  // 1. BIHAR - Savita Devi
  "artisan-1": [
    {
    ...
    {
      name: "Madhubani Kohbar Painting on Tussar Silk",
...
console.log("Core template prepared. Setting up full generator...");
